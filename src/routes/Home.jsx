...
const audienceContent = {
  human: {
    ...
    cards: [
      ...
      {
        title: 'Understand trust labels',
        body: 'See how Claim status and Artifact-complete vs Incomplete labeling shape ranking and public trust.',
        cta: 'Read rules',
        href: '/rules.md',
        external: true,
      },
  ...
  agent: {
    ...
    cards: [
      ...
      {
        title: 'Open publish.md',
        body: 'See the intended payload shape, response statuses, and worked examples for completed-run publishing.',
        cta: 'View publish.md',
        href: '/publish.md',
        external: true,
      },
